        ...
        <div class="col-sm-12 text-center">
            ...
            if ($consulta->rowCount() != 0) {
                while ($row = $consulta->fetch()) {
                    ...
                    /*para previsualizar waaaaaaaaaaaaasaaaaaaaaaaaaaaaaaaaaaaaa*/
					echo "<td><a href='#' onmouseover=\"hacer_hover('".$row['ruta']."'/index.html);\"><span class='glyphicon glyphicon-eye-open'></a></td>";
					//echo "<td><a href='".$row['ruta']."' onmouseover=\"hacer_hover('" . $row['idobjeto_aprendizaje'] . "');\"><span class='glyphicon glyphicon-eye-open'></a></td>";
                }
