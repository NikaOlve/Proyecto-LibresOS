...
<div class="container-fluid text-center">
	...
	<div class="container">
            <div class="row content">
                ...
                <div class="col-sm-12 text-center">
                        <h2> <img src="../../images/participa2.jpg"style="float:left;width:300px;height:170px">PARTICIPA EN EL FORO</h2> 
                </div>
...
<?php
	...
	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		echo "</table>";
		echo "<a href='formulario.php?id&respuestas=$respuestas&identificador=$id'><button>Responder</button></a><br /><br />";
	}
